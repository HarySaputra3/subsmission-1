...
export default class HomePresenter {
  ...
  async render() {
    return `
      <section class="container page-transition">
        <h1 class="animate-in">My story</h1>
        <p class="animate-in">Ceritakan masalah mu</p>
  ...
  initMap() {
    ...
    L.Icon.Default.mergeOptions({
      iconUrl: `${import.meta.env.BASE_URL}storyku/images/location.png`,
  ...
  addStoryMarkers() {
    const myIcon = L.icon({
      iconUrl: import.meta.env.BASE_URL + "images/location.png",
      iconSize: [25, 41],
      iconAnchor: [12, 41],
